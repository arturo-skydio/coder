...
func TestAICostControlConfigParsing(t *testing.T) {
	t.Parallel()
	...
	t.Run("Defaults", func(t *testing.T) {
		...
		assert.Equal(t, string(codersdk.AIBudgetPolicyHighest), dv.AI.CostControl.BudgetPolicy)
		assert.Equal(t, string(codersdk.AIBudgetPeriodMonth), dv.AI.CostControl.BudgetPeriod)
	})
